...
class WatchLabel(CustomLabel):
    ...
    def SetLabelData(self):
        ...
        self.serialL.endorigin()
        self.serialL.origin(4,17)
        self.serialL.write_text("Model: " + self.model.get(), char_height=3, char_width=3, line_width=30, justification='L')
        self.serialL.endorigin()
